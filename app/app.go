...
var (
	...
	DefaultNodeHome = func(appName string) string {
		return os.ExpandEnv("$HOME/magicmessagebusd")
	}
	...
	ModuleBasics = module.NewBasicManager(
		...
		magicmessagebus.AppModuleBasic{},
...
type App struct {
	*baseapp.BaseApp
	...
	magicmessagebusKeeper magicmessagebuskeeper.Keeper
...
func New(
	...
	// send a MsgSend message to the bank
	//addr1, _ := sdk.AccAddressFromHex("cosmos1xm82mkw2jkwkdgq3r0cu8f92r9t2emm8m8xpuw")
	...
	app.mm = module.NewManager(
		...
		transferModule,
		magicmessagebus.NewAppModule(appCodec, app.magicmessagebusKeeper),
